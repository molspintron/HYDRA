...
Now HYDRA can be copiled using the Makefile generated by cmake::
...
Alternativly to cmake you can use a custom Makefile.
An example Makefile is given in the ./source directory, you can adjust it to your needs
and compile in the HYDRA directory via::
...
functions of surface atoms in this list). Example calculations can be found in ./

If all input files are present go to your working directory and run HYDRA::

    $ cd path/to/working/dir
    $ path/to/build/HYDRA (optional: > output.txt)
